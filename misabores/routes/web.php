...
//=============================================================================
Route::get('/buscar','Usuariocontroller@buscar')->name('buscar');
Route::get('/buscarc','Comentariocontroller@buscarc')->name('buscarc');
Route::get('/buscarr','Restaurantecontroller@buscarr')->name('buscarr');

Route::get('/buscara','Admincontroller@buscara')->name('buscara');

Route::get('/buscard','Donacioncontroller@buscard')->name('buscard');
//====================================================================================================================
...
Route::get('/Reporteusuarios/exportarpdf', 'UsuarioController@exportarpdf')->middleware('auth');
