  ...
  public function Guardaedicioncomentario (Request $Request)
{
  ...
  public function buscarc (Request $req){
    $crit=$req['criterio'];
    $consulta =\DB::select("SELECT Clave_comentario, estrella, aprobado, comentario FROM comentarios WHERE Clave_comentario='$crit' or estrella='$crit' or aprobado='$crit' or comentario LIKE '%$crit%' ");
    return view("Reportecomentario",["consulta"=>$consulta, 'crit'=> $crit]);
  }
