  ...
  public function Guardaedicionusuario (Request $Request)
{
  ...
  public function buscar (Request $req){
    ...
    $consulta =\DB::select("SELECT Clave_usuario,nombre,app_usu,apm_usu,sex_usu,tel_usu,
                            calle_usu,ncalle_usu,colonia_usu,municipio_usu,cp_usu,
                            estado_usu,activo FROM usuarios WHERE nombre LIKE '%$crit%' or app_usu LIKE '%$crit%' or apm_usu LIKE 
                            '%$crit%' or sex_usu='%$crit%' or tel_usu='%$crit%' or calle_usu LIKE '%$crit%' or colonia_usu LIKE '%$crit%' or municipio_usu LIKE '%$crit%' or cp_usu='%$crit%' ");
    return view("Reporteusuario",["consulta"=>$consulta, 'crit'=> $crit]);
  }
  ...
  public function exportarpdf()
    {
        ...
        $pdf = PDF::loadview('Reporteusuario.pdf', compact('Reporteusuario'));
